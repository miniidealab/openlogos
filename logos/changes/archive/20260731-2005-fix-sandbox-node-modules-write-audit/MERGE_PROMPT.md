...
## 变更提案
- 提案名称：fix-sandbox-node-modules-write-audit
- 提案目录：logos/changes/fix-sandbox-node-modules-write-audit/
...
- Delta 文件：`logos/changes/fix-sandbox-node-modules-write-audit/deltas/prd/1-product-requirements/core-01-requirements.md`
...
- Delta 文件：`logos/changes/fix-sandbox-node-modules-write-audit/deltas/prd/2-product-design/1-feature-specs/core-01-feature-specs.md`
- 目标目录：`logos/resources/prd/2-product-design/1-feature-specs/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 3. deltas/prd/3-technical-plan/2-scenario-implementation/core-S13-verify-results.md

- Delta 文件：`logos/changes/fix-sandbox-node-modules-write-audit/deltas/prd/3-technical-plan/2-scenario-implementation/core-S13-verify-results.md`
...
- Delta 文件：`logos/changes/fix-sandbox-node-modules-write-audit/deltas/prd/3-technical-plan/2-scenario-implementation/core-S19-smoke-gate.md`
- 目标目录：`logos/resources/prd/3-technical-plan/2-scenario-implementation/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 5. deltas/test/core-S13-test-cases.md

- Delta 文件：`logos/changes/fix-sandbox-node-modules-write-audit/deltas/test/core-S13-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 6. deltas/test/core-S19-test-cases.md

- Delta 文件：`logos/changes/fix-sandbox-node-modules-write-audit/deltas/test/core-S19-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档
...
8. 所有变更合并完成后，自动执行 git commit（告知用户，无需确认）：
   git add -A && git commit -m "docs(fix-sandbox-node-modules-write-audit): merge spec deltas"
   然后提示用户：按更新后的规格实现代码，代码完成后运行 `openlogos verify` 验收，验收通过后明确授权执行 `openlogos archive fix-sandbox-node-modules-write-audit`。
