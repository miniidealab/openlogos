...
## 变更提案
- 提案名称：fix-scenario-create-completeness-contract
- 提案目录：logos/changes/fix-scenario-create-completeness-contract/
...
- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/prd/1-product-requirements/core-01-requirements.md`
...
- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/prd/2-product-design/1-feature-specs/core-01-feature-specs.md`
- 目标目录：`logos/resources/prd/2-product-design/1-feature-specs/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 3. deltas/prd/3-technical-plan/1-architecture/core-01-architecture-overview.md

- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/prd/3-technical-plan/1-architecture/core-01-architecture-overview.md`
- 目标目录：`logos/resources/prd/3-technical-plan/1-architecture/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 4. deltas/prd/3-technical-plan/2-scenario-implementation/core-S39-baseline-on-touch.md

- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/prd/3-technical-plan/2-scenario-implementation/core-S39-baseline-on-touch.md`
...
- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/prd/3-technical-plan/3-deployment/core-01-deployment-plan.md`
- 目标目录：`logos/resources/prd/3-technical-plan/3-deployment/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 6. deltas/skills/change-writer/SKILL.md

- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/skills/change-writer/SKILL.md`
- 目标目录：`skills/change-writer/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 7. deltas/skills/scenario-architect/SKILL.md

- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/skills/scenario-architect/SKILL.md`
- 目标目录：`skills/scenario-architect/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 8. deltas/spec/baseline-closure.md

- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/spec/baseline-closure.md`
- 目标目录：`spec/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 9. deltas/spec/change-management.md

- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/spec/change-management.md`
- 目标目录：`spec/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 10. deltas/test/core-S39-test-cases.md

- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/test/core-S39-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 11. deltas/test/smoke/core-smoke-test-cases.md

- Delta 文件：`logos/changes/fix-scenario-create-completeness-contract/deltas/test/smoke/core-smoke-test-cases.md`
...
8. 所有变更合并完成后，自动执行 git commit（告知用户，无需确认）：
   git add -A && git commit -m "docs(fix-scenario-create-completeness-contract): merge spec deltas"
   然后提示用户：按更新后的规格实现代码，代码完成后运行 `openlogos verify` 验收，验收通过后明确授权执行 `openlogos archive fix-scenario-create-completeness-contract`。
