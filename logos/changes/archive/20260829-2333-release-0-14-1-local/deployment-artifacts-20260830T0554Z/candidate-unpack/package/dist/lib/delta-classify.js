...
export const DELTA_TO_RESOURCE = {
...
export function classifyProposalDeltas(proposalDir) {
    const out = [];
    ...
    const contained = (p) => (p + sep).startsWith(proposalReal + sep);
    ...
    if (!existsSync(deltasDir))
        return out;
    const walk = (dirAbs, relParts, category) => {
        let names;
        try {
...
export function listEvidenceTestDeltaFiles(proposalDir) {
...
//# sourceMappingURL=delta-classify.js.map