...
import { runChangeLint, isDangerousSlug, SLUG_STRICT_RE } from '../lib/change-lint.js';
...
export function changeLint(slugArg, format = 'text') {
    ...
    if (slugArg !== undefined) {
        ...
        if (existsSync(guardPath)) {
            try {
                ...
                if (guard && typeof guard.activeChange === 'string')
                    active = guard.activeChange.trim();
            }
