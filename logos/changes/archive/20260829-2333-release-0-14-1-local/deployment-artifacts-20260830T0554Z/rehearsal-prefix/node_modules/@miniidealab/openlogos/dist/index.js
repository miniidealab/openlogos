...
Commands:
  init [name]        Initialize a new OpenLogos project structure
                       ...
                       --ai-tool <claude-code|opencode|codex|cursor|zcode|qoder|workbuddy|other|all>  Set AI tool (skip prompt)
                       --aitool <claude-code|opencode|codex|cursor|zcode|qoder|workbuddy|other|all>   Alias for --ai-tool
...
async function main() {
    ...
    switch (command) {
        ...
        case 'baseline-seed': {
            ...
            switch (sub) {
                case 'begin':
                    baselineSeedBegin(moduleArg, manifestArg, format);
                    break;
                case 'commit':
                    baselineSeedCommit(moduleArg, runIdArg, format);
                    break;
                case 'status':
                    baselineSeedStatus(moduleArg, format);
                    break;
                default:
        ...
        case 'module': {
            ...
            switch (sub) {
                ...
                case 'add':
                    ...
                    break;
                case 'rename':
                    moduleRename(args[2], args[3]);
                    break;
                case 'remove':
                    moduleRemove(args[2]);
                    break;
                case 'set-product-type':
                    moduleSetProductType(args[2], args[3], format);
                    break;
                default:
