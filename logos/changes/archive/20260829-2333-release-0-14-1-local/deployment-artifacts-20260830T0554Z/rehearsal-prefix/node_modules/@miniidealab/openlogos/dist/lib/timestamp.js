 ...
 */
export function parseStrictTimestampParts(ts) {
    if (typeof ts !== 'string')
        return null;
    ...
    if (mo < 1 || mo > 12 || d < 1 || hh > 23 || mi > 59 || sec > 59)
        return null;
