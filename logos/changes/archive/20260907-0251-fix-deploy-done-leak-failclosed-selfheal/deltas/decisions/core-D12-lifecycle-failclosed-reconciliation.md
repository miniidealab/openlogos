# core-D12-lifecycle-failclosed-reconciliation delta — fix-deploy-done-leak-failclosed-selfheal（CREATE，整文档）

## ADDED — D12：生命周期命令 fail-closed 校验上游事实，status/next 对矛盾事实显式对账
