...
## 变更提案
- 提案名称：fix-plan-package-convergence-gap
- 提案目录：logos/changes/fix-plan-package-convergence-gap/
...
- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/prd/1-product-requirements/core-01-requirements.md`
...
- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/prd/2-product-design/1-feature-specs/core-01-feature-specs.md`
- 目标目录：`logos/resources/prd/2-product-design/1-feature-specs/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 3. deltas/prd/3-technical-plan/1-architecture/core-01-architecture-overview.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/prd/3-technical-plan/1-architecture/core-01-architecture-overview.md`
- 目标目录：`logos/resources/prd/3-technical-plan/1-architecture/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 4. deltas/prd/3-technical-plan/2-scenario-implementation/core-00-scenario-overview.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/prd/3-technical-plan/2-scenario-implementation/core-00-scenario-overview.md`
...
- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/prd/3-technical-plan/2-scenario-implementation/core-S05-next-guidance.md`
- 目标目录：`logos/resources/prd/3-technical-plan/2-scenario-implementation/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 6. deltas/prd/3-technical-plan/2-scenario-implementation/core-S08-sync-ai-tools.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/prd/3-technical-plan/2-scenario-implementation/core-S08-sync-ai-tools.md`
- 目标目录：`logos/resources/prd/3-technical-plan/2-scenario-implementation/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 7. deltas/prd/3-technical-plan/2-scenario-implementation/core-S09-change-lifecycle.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/prd/3-technical-plan/2-scenario-implementation/core-S09-change-lifecycle.md`
- 目标目录：`logos/resources/prd/3-technical-plan/2-scenario-implementation/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 8. deltas/prd/3-technical-plan/2-scenario-implementation/core-S11-status-progress.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/prd/3-technical-plan/2-scenario-implementation/core-S11-status-progress.md`
- 目标目录：`logos/resources/prd/3-technical-plan/2-scenario-implementation/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 9. deltas/prd/3-technical-plan/2-scenario-implementation/core-S35-change-lint.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/prd/3-technical-plan/2-scenario-implementation/core-S35-change-lint.md`
- 目标目录：`logos/resources/prd/3-technical-plan/2-scenario-implementation/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 10. deltas/prd/3-technical-plan/3-deployment/core-01-deployment-plan.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/prd/3-technical-plan/3-deployment/core-01-deployment-plan.md`
- 目标目录：`logos/resources/prd/3-technical-plan/3-deployment/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 11. deltas/skills/change-writer/SKILL.en.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/skills/change-writer/SKILL.en.md`
- 目标目录：`skills/change-writer/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 12. deltas/skills/change-writer/SKILL.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/skills/change-writer/SKILL.md`
- 目标目录：`skills/change-writer/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 13. deltas/spec/change-management.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/spec/change-management.md`
- 目标目录：`spec/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 14. deltas/spec/cli-json-output.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/spec/cli-json-output.md`
- 目标目录：`spec/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 15. deltas/spec/flow-spec.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/spec/flow-spec.md`
- 目标目录：`spec/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 16. deltas/spec/schema/next.schema.json

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/spec/schema/next.schema.json`
- 目标目录：`spec/schema/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 17. deltas/spec/schema/status.schema.json

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/spec/schema/status.schema.json`
- 目标目录：`spec/schema/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 18. deltas/spec/tasks-spec.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/spec/tasks-spec.md`
- 目标目录：`spec/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 19. deltas/test/core-S05-test-cases.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/test/core-S05-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 20. deltas/test/core-S08-test-cases.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/test/core-S08-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 21. deltas/test/core-S09-test-cases.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/test/core-S09-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 22. deltas/test/core-S11-test-cases.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/test/core-S11-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 23. deltas/test/core-S35-test-cases.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/test/core-S35-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 24. deltas/test/smoke/core-smoke-test-cases.md

- Delta 文件：`logos/changes/fix-plan-package-convergence-gap/deltas/test/smoke/core-smoke-test-cases.md`
...
8. 所有变更合并完成后，自动执行 git commit（告知用户，无需确认）：
   git add -A && git commit -m "docs(fix-plan-package-convergence-gap): merge spec deltas"
   然后提示用户：按更新后的规格实现代码，代码完成后运行 `openlogos verify` 验收，验收通过后明确授权执行 `openlogos archive fix-plan-package-convergence-gap`。
