...
function environmentFor(runner) {
  ...
  const hostArtifacts = {
    ...
    'scripts/smoke-cursor-staging.js': {
    ...
    'scripts/smoke-merge-reopen-0-14-20.js': {
      tarball: process.env.OPENLOGOS_MERGE_REOPEN_TARBALL,
      previousTarball: process.env.OPENLOGOS_MERGE_REOPEN_ROLLBACK_TARBALL,
    },
    'scripts/smoke-guard-hook-0-14-21.js': {
    ...
    'scripts/smoke-next-ensure-0-14-23.js': {
      tarball: process.env.OPENLOGOS_NEXT_ENSURE_TARBALL,
      previousTarball: process.env.OPENLOGOS_NEXT_ENSURE_ROLLBACK_TARBALL,
    },
    'scripts/smoke-guard-bash-0-14-24.js': {
      tarball: process.env.OPENLOGOS_GUARD_BASH_TARBALL,
      previousTarball: process.env.OPENLOGOS_GUARD_BASH_ROLLBACK_TARBALL,
    },
    'scripts/smoke-lifecycle-failclosed-0-14-25.js': {
    ...
    'scripts/smoke-readlock-concurrency-0-14-13.js': {
      tarball: process.env.OPENLOGOS_READLOCK_TARBALL,
      previousTarball: process.env.OPENLOGOS_READLOCK_ROLLBACK_TARBALL,
      candidateBin: process.env.OPENLOGOS_READLOCK_CANDIDATE_BIN,
    },
    'scripts/smoke-single-slice-verdict-0-14-14.js': {
      tarball: process.env.OPENLOGOS_SINGLE_VERDICT_TARBALL,
