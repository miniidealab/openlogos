      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Orchestratable Flow', translations: { 'zh-CN': '可编排研发流程' }, slug: 'concepts/orchestratable-flow' },
          ],
        },
        {
          label: 'CLI Reference',
          ...
          items: [
            ...
            { label: 'flow show', slug: 'cli/flow-show' },
            { label: 'verify', slug: 'cli/verify' },
            { label: 'smoke', slug: 'cli/smoke' },
            { label: 'deploy-done', slug: 'cli/deploy-done' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Flow Spec', translations: { 'zh-CN': 'Flow 规格' }, slug: 'specs/flow-spec' },
            { label: 'Change Management', translations: { 'zh-CN': '变更管理' }, slug: 'specs/change-management' },
            { label: 'Slice Planner', translations: { 'zh-CN': '切片规划' }, slug: 'specs/slice-planner' },
