...
Commands:
  init [name]        Initialize a new OpenLogos project structure
                       ...
                       --ai-tool <claude-code|opencode|codex|cursor|zcode|qoder|other|all>  Set AI tool (skip prompt)
                       --aitool <claude-code|opencode|codex|cursor|zcode|qoder|other|all>   Alias for --ai-tool
