...
describe('S35 — 同源锚与契约', () => {
  ...
  it('UT-S35-21 / UT-S35-37: 违规集契约——四字段必填、39 码闭合（含 Plan Package L0）、排序稳定', () => {
    const { root, dir } = setup({
    ...
    expect(registry.size).toBe(39); // 原 36 码 + Plan Package L0 的 11 码，减去随 L10 删除的 5 码与随 L9 删除的 8 码
