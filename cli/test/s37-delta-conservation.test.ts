...
describe('S37 — 契约、同源与零漂移', () => {
  ...
  it('UT-S37-31: 零回归——枚举 37 码闭合；合法 delta 零 L8 违规、既有判据不受影响', () => {
    expect(CHANGE_LINT_VIOLATION_CODES).toHaveLength(37);
    expect(new Set(CHANGE_LINT_VIOLATION_CODES).size).toBe(37);
